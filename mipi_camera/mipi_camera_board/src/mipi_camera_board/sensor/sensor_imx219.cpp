...
void setImx219(SensorSetting& sensor_setting)
{
	printf("set_sensor_imx219_param\n");
	/*定义 sensor   初始化的属性信息 */
	sensor_setting.snsinfo = SENSOR_2LANE_IMX219_15FPS_2464P_10BIT_LINEAR_INFO;
	/*定义 mipi 初始化参数信息 */
	sensor_setting.mipi_attr = MIPI_2LANE_SENSOR_IMX219_15FPS_2464P_10BIT_LINEAR_ATTR;
	/*定义 dev 初始化的属性信息 */
	sensor_setting.devinfo = DEV_ATTR_IMX219_15FPS_2464P_LINEAR_BASE;
	/*定义 pipe 属性信息 */
	sensor_setting.pipeinfo = PIPE_ATTR_IMX219_15FPS_2464P_LINEAR_BASE;
	/*定义 dis 属性信息 */
	sensor_setting.disinfo = DIS_ATTR_IMX219_15FPS_2464P_LINEAR_BASE;
	/*定义 ldc 属性信息 */
	sensor_setting.ldcinfo = LDC_ATTR_IMX219_15FPS_2464P_LINEAR_BASE;
	// return sensor_sif_dev_init(multi_sensors[1],1);
}
